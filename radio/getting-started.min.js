  ...
  render() {
    ...
    return u`
      <fieldset
        ...
        part="radio-group"
        role="radiogroup"
        aria-invalid="${o$1(this.isInvalid ? 'true' : undefined)}"
...
async function resetStateExample() {
