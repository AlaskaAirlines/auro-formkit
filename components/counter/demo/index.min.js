 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const a$1=Symbol.for(""),o$2=t=>{if(t?.r===a$1)return t?._$litStatic$},l$1=new Map,n$2=t=>(r,...e)=>{const a=e.length;let s,i;const n=[],u=[];let c,$=0,f=!1;for(;$<a;){for(c=r[$];$<a&&void 0!==(i=e[$],s=o$2(i));)c+=s+r[++$],f=!0;$!==a&&u.push(i),n.push(c),$++;}if($===a&&n.push(r[a]),f){const t=n.join("$$lit$$");void 0===(r=l$1.get(t))&&(n.raw=n,l$1.set(t,r=n)),e=u;}return t(r,...e)},u$1=n$2(x);
...
var styleCss = i$2`:host{position:relative}`;
