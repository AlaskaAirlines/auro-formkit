...
export const TypeTel = stories.TypeTel;
export const InDrawer = stories.InDrawer;
export const DisabledOption = stories.DisabledOption;
export const CssParts = stories.CssParts;
export const CustomValidityMessage = stories.CustomValidityMessage;
