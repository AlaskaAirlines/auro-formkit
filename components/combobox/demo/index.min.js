...
var tokensCss$5 = i$5`:host{--ds-auro-icon-color: var(--ds-color-icon-primary-default, $ds-color-icon-primary-default);--ds-auro-icon-size: var(--ds-size-300, $ds-size-300)}`;
...
class AuroDropdown extends r$1 {
  ...
  privateDefaults() {
    ...
    this.iconTag = versioning.generateTag('auro-icon', iconVersion$2, AuroIcon);
  }
...
class AuroCombobox extends r$1 {
  ...
  static register(name = "auro-combobox") {
    AuroLibraryRuntimeUtils$1.prototype.registerComponent(name, AuroCombobox);
  }
