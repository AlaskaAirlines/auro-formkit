...
function runFulltest(mobileview) {
  ...
  it("hides the bib when making a selection", async () => {
    ...
    el.menu.dispatchEvent(
      new CustomEvent("auroMenu-selectedOption", {
        bubbles: true,
        composed: true,
      }),
    );
  ...
  it("fires input event on typing", async () => {
    ...
    if (mobileview) {
      await waitUntil(
        () =>
          el.dropdown.isPopoverVisible && el.input.parentNode !== el.dropdown,
      );
    } else {
  ...
  it("using the nomatch attribute with no matching value", async () => {
    ...
    await expect(visibleMenuOptions.length).to.be.equal(1);
    await expect(visibleMenuOptions[0].innerText).to.be.equal(
      "No Matching Option",
    );
  });
...
async function suggestFixture(mobileview) {
  ...
  return await fixture(html`
    <auro-combobox>
      ...
      <auro-menu>
        <auro-menuoption value="Apples" id="option-0">Apples</auro-menuoption>
        <auro-menuoption value="Oranges" suggest="Apples" id="option-1"
          >Oranges</auro-menuoption
        >
      </auro-menu>
    </auro-combobox>
  `);
  ...
  return await fixture(html`
    <auro-combobox>
      ...
      <auro-menu>
        <auro-menuoption value="Apples" id="option-0">Apples</auro-menuoption>
        <auro-menuoption value="Oranges" id="option-1">Oranges</auro-menuoption>
        <auro-menuoption nomatch id="option-noMatch"
          >No Matching Option</auro-menuoption
        >
      </auro-menu>
    </auro-combobox>
  `);
  ...
  return await fixture(html`
    <auro-combobox>
      ...
      <auro-menu>
        <auro-menuoption value="Apples" id="option-0">Apples</auro-menuoption>
        <auro-menuoption value="Oranges" id="option-1">Oranges</auro-menuoption>
        <auro-menuoption persistent id="option-noMatch"
          >Persistent</auro-menuoption
        >
      </auro-menu>
    </auro-combobox>
  `);
