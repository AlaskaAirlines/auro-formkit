...
<div class="contentWrapper">
  <nav>
    <auro-nav anchorNavContent=".scrollWrapper">
      ...
      <auro-anchorlink fluid href="#design">Design</auro-anchorlink>
...
<!-- AURO-GENERATED-CONTENT:END -->
      ...
      <section>
        <auro-header level="2" id="design">Design</auro-header>
<!-- AURO-GENERATED-CONTENT:START (FILE:src=./../docs/partials/design.md) -->
<!-- AURO-GENERATED-CONTENT:END -->
      </section>
      <section>
        <auro-header level="2" id="initialState">Initial Render State</auro-header>
        <p>
          When the component first renders in its default use case the value is <code>undefined</code>, the input is empty, and the first enabled option is marked <code>active</code>. The component will initially render with the option list collapsed.
        </p>
      </section>
      <section>
