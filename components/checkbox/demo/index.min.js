  ...
  render() {
    ...
    return x`
      <div class="cbxContainer" part="checkbox">
        ...
        <label for="${o(this.id)}" class="${e(labelClasses)}" part="checkbox-label">
...
class AuroCheckboxGroup extends r {
  constructor() {
    super();
    ...
    return x`
      <fieldset class="${e(groupClasses)}">
        ${this.required
          ...
          : x`<legend><slot name="legend"></slot> (optional)</legend>`
        }
