...
<!-- AURO-GENERATED-CONTENT:END -->
      ...
      <section>
        ...
        <p class="authorTodo">TODO: Seems easy to do... any reason not to do this? Looks like we can use <code>if (window.matchMedia('(speech)').matches)</code> to support custom behavior when VoiceOver is on or off.<br/><br/> 
        <p>NVM - this media query is deprecated.</p><br/><br/> 
        Some excelent info about improving touch / gesture / mouse support here we should seriously consider: <a href="https://web.dev/articles/add-touch-to-your-site">https://web.dev/articles/add-touch-to-your-site</a></p>
