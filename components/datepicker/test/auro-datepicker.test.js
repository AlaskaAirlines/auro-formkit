...
function runFullTest(mobileView) {
  ...
  describe('Private Functions', () => {
    ...
    it('handleMonthChange falls back to firstRenderedMonth when centralDate is invalid', async () => {
      ...
      expect(mockElem.centralDate).to.be.an.instanceOf(Date);
      expect(mockElem.centralDate.getMonth()).to.equal(3); // April = month 3
      expect(mockElem.centralDate.getFullYear()).to.equal(2025);
    });
