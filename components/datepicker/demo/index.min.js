...
class AuroCalendar extends RangeDatepicker {
  ...
  renderAllCalendars() {
    if (this.isVisible) {
      ...
      const dropdown = AuroLibraryRuntimeUtils$3.prototype.closestElement('auro-dropdown, [auro-dropdown]', this);
      const dropdownbib = dropdown ? dropdown.bibContent : AuroLibraryRuntimeUtils$3.prototype.closestElement('auro-dropdownbib', this);
