      ...
      if (elem.type === 'email') {
        ...
        if (elem.value && !elem.valueObject) {
          ...
          if (isPartialDateFormat) {
            ...
            // Valid partial date — skip max/min checks since valueObject is undefined for partial formats.
            return;
          }
...
var formkitVersion$1 = '202607011749';
  ...
  handleDropdownToggle(event) {
    ...
    if (!this.isPopoverVisible) {
      ...
      setTimeout(() => {
        ...
        if (this.isPopoverVisible || !this.bibContent.matches(':focus-within')) {
          return;
        }
...
var formkitVersion = '202607011749';
