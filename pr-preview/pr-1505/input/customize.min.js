...
class AuroInputUtilities {
  ...
  toFormattedValue(valueObject, format) {
    ...
    if (!(valueObject instanceof Date) || Number.isNaN(valueObject.getTime())) {
      return undefined;
    }

    if (!maskOptions || typeof maskOptions.format !== 'function') {
      console.warn('Invalid mask options for date formatting', { format, maskOptions }); // eslint-disable-line no-console
      return undefined;
    }
