    ...
    if (this.trigger.hasAttribute('tabindex')) {
      ...
      if (slot) {
        ...
        for (const el of assigned) {
          ...
          // Prefer focusing a real focusable descendant of the assigned node
          // (e.g. a <button> inside a wrapper). If none are found, fall back to
          // focusing the assigned element itself (works for custom elements that
          // implement focus() or delegatesFocus).
          if (focusables.length > 0) {
            focusables[0].focus();
            return;
          }
