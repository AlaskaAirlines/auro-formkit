...
class AuroInputUtilities {
   ...
   */
  toNorthAmericanFormat(dateStr, format$1) {
    const maskForLocale = this.getDateMaskFromLocale(this.locale);
    const parsedDate = this.parseDateByMask(dateStr, format$1 || maskForLocale);
    ...
    return {
      ...
      dateForComparison: format(parsedDate, 'MM/dd/yyyy')
    };
  }
   ...
   * @returns {string}
   */
  toLocaleFormat(dateStr, format$1) {
    const maskForLocale = this.getDateMaskFromLocale(this.locale);
    const parsedDate = this.parseDateByMask(dateStr, format$1 || maskForLocale);
    ...
    return format(parsedDate, this.toDateFnsMask(maskForLocale));
  }
...
var formkitVersion = '202605071530';
