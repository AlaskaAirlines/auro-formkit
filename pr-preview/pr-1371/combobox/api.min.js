  ...
  validateType(elem) {
    if (elem.hasAttribute('type')) {
      if (elem.type === 'email') {
        ...
        if (!dateAndFormatMatch$1(elem.inputElement.value, elem.format)) {
          elem.validity = 'patternMismatch';
        ...
        if (!validDateStr$1(elem.inputElement.value, elem.format)) {
...
var formkitVersion$2 = '202605061740';
...
var formkitVersion$1 = '202605061740';
