  ...
  <div class="mainContent">
    <div class="scrollWrapper">
      <section>
        ...
        <ol>
          <li><strong>On focus:</strong> Announces <em>"[label], [current value or 'no selection'], combo box"</em> — role changes from <strong>"pop-up button"</strong> to <strong>"list box"</strong></li>
