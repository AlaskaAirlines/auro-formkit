...
const selectKeyboardStrategy = {
  ...
  Home(component, evt) {
    ...
    const firstOption = component.menu.menuService.menuOptions[0];
    if (firstOption) {
  ...
  End(component, evt) {
    evt.preventDefault();
    evt.stopPropagation();
    const lastOption = component.menu.menuService.menuOptions[component.menu.menuService.menuOptions.length - 1];
    if (lastOption) {
  ...
  configureDropdown() {
    ...
    this.dropdown.addEventListener('auroDropdown-toggled', () => {
      ...
      if (!this.dropdown.isPopoverVisible) {
        ...
        // if the dropdown closes by Tab, focus should be moved to next/prev element if the bib was not fullscreen
