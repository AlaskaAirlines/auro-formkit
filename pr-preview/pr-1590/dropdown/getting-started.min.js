...
class AuroInput extends BaseInput {
  ...
  constructor() {
     ...
     * @private
     */
    this.buttonTag = versioning.generateTag('auro-formkit-input-button', buttonVersion, T);
