...
| [centralDate](#centralDate)                     | `centralDate`                     |           | `string`                                         |                                                  | The date that determines the currently visible month.<br />The date will be fixed to the first of the month internally.<br />So that changing the month to the next or previous month will work as expected even if the value is set to a date in the last days of the month. |
