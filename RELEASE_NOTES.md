...
- `auro-combobox` now opens its bib and shows the loading indicator while options load asynchronously, and `auro-select`'s loading placeholder is correctly centered and sized to the trigger.
